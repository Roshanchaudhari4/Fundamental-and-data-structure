...
#include<iostream>
using namespace std;
#define size 10           //size 10 decleared kele
...
int main(){
    ...
    cout<<"Enter the expression to check it is well form or not:";
    cin>>exp;
    ...
    {
        cout<<"sorry,invalid expression or not in well parathesized"<<endl;
    }
    return 0;
}
